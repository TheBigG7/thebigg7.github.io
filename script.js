...
document.addEventListener('DOMContentLoaded', () => {
    ...
    { type: 'table-tf', question: 'Seleccione si es verdadero o falso los siguientes criterios para plantear un problema de investigación cuantitativa:', rows: [ { statement: 'El planteamiento debe implicar la posibilidad de ser investigado empíricamente.', correct: 'Verdadero' }, { statement: 'El problema debe estar formulado como pregunta, claramente y sin ambigüedad.', correct: 'Verdadero' }, { statement: 'El planteamiento debe ser estético. Por ejemplo, no es correcto bajo ninguna circunstancia trabajar algo que pueda dañar a seres humanos o implique racismo.', correct: 'Verdadero' }, { statement: 'Cuando el problema asocia variables, fenómenos, eventos, hechos, etc., la o las relaciones deben expresarse de manera general.', correct: 'Falso' } ] },
